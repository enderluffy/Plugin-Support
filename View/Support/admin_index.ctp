	...
	<div class="row">
		...
		<div class="col-sm-12">
			<div class="alert alert-warning">
				<b>Support Plugin | V1.0.16 | Information</b>
				<br /> Cette màj apporte des modifications importantes dans le code source et vous pouvez rencontrer des erreurs internes. 
				<br /> Pensez à vider le cache correctement en supprimant le dossier <b>app/tmp/cache</b>.
			</div>
		</div>
		<?php endif; ?>
        <div class="col-md-3">
			<div class="box box-solid">
				<div class="box-header with-border">
				  <h3 class="box-title">Liste des états de ticket</h3>
				  <div class="box-tools">
        ...
        <div class="col-md-9">
			<div class="box box-<?= $stateCurrentData['customClass']; ?>">
				...
				<?php if(empty($tickets)): ?>
					<div class="box-body">
						Aucun ticket n'est dans l'état <span class="label label-<?= $stateCurrentData['customClass']; ?>"><?= $stateCurrentData['name']; ?></span>
					</div>
				<?php else: ?>
				<div class="box-body no-padding">
								...
								<tr>
									...
									<td>
										<div class="btn-group">
											...
											<?php }?>
											<button type="button" class="btn btn-<?= $stateCurrentData['customClass']; ?>"><i class="fa fa-cog"></i> Options</button>
